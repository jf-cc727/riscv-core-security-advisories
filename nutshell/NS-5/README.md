# NutShell PTW Access-Fault Misclassification Package

This package is for CVE review.

Issue link: `https://github.com/OSCPU/NutShell/issues/264`
...
**Candidate title.** OSCPU NutShell misclassifies page-table-walk access faults as page faults, which can reroute traps away from machine-mode policy
