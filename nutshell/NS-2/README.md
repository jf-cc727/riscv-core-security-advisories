# NutShell `mtvec` Trap-Target Truncation Package

This package is for CVE review.

Issue link: `https://github.com/OSCPU/NutShell/issues/261`
...
**Candidate title.** OSCPU NutShell preserves upper bits in `mtvec` readback but truncates the actual trap target, enabling low-alias machine-mode redirection on affected SoCs
