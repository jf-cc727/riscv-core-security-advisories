# NutShell `minstret` Reset Visibility Package

This package is for CVE review.

Issue link: `https://github.com/OSCPU/NutShell/issues/260`
...
**Candidate title.** OSCPU NutShell does not make an architectural `minstret` reset visible to the next read, allowing stale instruction-count state to cross isolation boundaries
