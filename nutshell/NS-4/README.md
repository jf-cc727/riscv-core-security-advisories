# NutShell One-Instruction-Stale `minstret` Visibility Package

This package is for CVE review.

Issue link: `https://github.com/OSCPU/NutShell/issues/263`
...
**Candidate title.** OSCPU NutShell may expose a one-instruction-stale `minstret` value at live policy checks, enabling off-by-one boundary mis-accounting
